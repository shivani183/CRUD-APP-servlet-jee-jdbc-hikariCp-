	...
	private void doProcess(HttpServletRequest request, HttpServletResponse response)
		...
		if (request.getRequestURI().endsWith("searchform")) {
			...
			if(status=="success") {
				out.println("<body>");
				out.println("<center>");
				out.println("<h1 style='color:green;text-align:center;'>RECORD DELETED SUCCESSUFULLY " + sid
						+ "</h1>");
				out.println("</center>");
				out.println("</body>");
				...
				out.println("<body>");
				out.println("<center>");
				out.println("<h1 style='color:red;text-align:center;'>RECORD DELETION FAILED " + sid
						+ "</h1>");
				out.println("</center>");
				out.println("</body>");
			}else {
				out.println("<body>");
				out.println("<center>");
				out.println("<h1 style='color:orange;text-align:center;'>RECORD NOT AVAILABLE FOR THE GIVEN ID " + sid
						+ "</h1>");
				out.println("</center>");
				out.println("</body>");
			}
